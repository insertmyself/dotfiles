...
vim.keymap.set("n", "<C-p>", "<CMD>BufferLineCycleNext<CR>", { silent = true, desc = "Cycle to the next buffer" })
vim.keymap.set("n", "<C-i>", "<CMD>BufferLineCyclePrev<CR>", { silent = true, desc = "Cycle to the previous buffer" })
vim.keymap.set(
	"n",
	"<leader>bn",
